...
| 7, 7a | Corrected EventFrame-corpus recall remains below 100 ms p99 under the tested 16-worker mixed workload. | Falsified in runtime fixture | Embedded recall p99 was 218.75 ms and the best remote tested configuration measured 219.85 ms, both with zero EventFrame request errors. |
