...
| 2c | Elastic rank correction improves the inspected real-session regression block over the previous full upgrade. | Supported in retrospective regression | Recall@10 rose 42.85% to 46.50%, packed recall 32.56% to 35.79%, and MRR 89.88% to 93.27%; Brier was unchanged. |
...
| 2b, 2c | One frozen calibration map remains valid across retrieval-frontier regimes. | Falsified in retrospective reproducibility replay | Design Brier regressed 0.20568 to 0.47441 and nomination regimes differed; confirmation was already inspected. |
